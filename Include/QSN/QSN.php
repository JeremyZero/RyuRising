...
<p>Ryu Rising a été crée par Jérémy Filin et Nagui Deliquaire en Janvier 2020.<br>
Sur une base de projet pédagogique de formation Developpeur Web et Web Mobile à l'ICS de Nice,<br>
"Nous avons eu l'idée d'une boisson énergisante qui nous ressemble.<br>
Nous sommes tous deux passionnés par les Manga et la culture Japonaise ainsi que des Jeux Video,<br>
du coup ça semblait logique pour nous de créer une boisson qui allie nos passions."</p>
<img id="logoQSN" src="../images/Ryurisinglogo.png" alt="">
</div>
<div id="Barrenoire">
...
<div id="imgQSN">
<img id="potsQSN" src="../images/potsQSN.png" alt="">
</div>
<div id="Why">
